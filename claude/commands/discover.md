...
**Thoroughness is a method, not a resolve:** enumerate what the premise depends on, check it against
the real tree with real data (not a fixture), and hunt the class behind the instance rather than
settling for the one symptom the ticket named.
